export default function OfflinePage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="text-xl font-semibold mb-2">Нет подключения к интернету</h1>
      <p className="text-muted-foreground max-w-sm">
        Проверьте соединение и попробуйте снова. Приложение заработает, как только появится сеть.
      </p>
    </div>
  );
}
